...
public class ConditionConverter extends WrapperThread
{
	private static transient final Logger logger = LogManager.getLogger(ConditionConverter.class);

	long basketId;

	public ConditionConverter(long basket)
	{
