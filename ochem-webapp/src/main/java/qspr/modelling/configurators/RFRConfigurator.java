...
public class RFRConfigurator extends DescriptorsConfigurator 
{
	...
	public void setModel(Model model)
	{
		...
		((CDSConfiguration)model.attachment.getObject().configuration).modelConfiguration = new RFRConfiguration();
		this.stepAfterDescriptors = "rfr";
	}

	public WebModel rfr()
	{
		return new WebModel(getDefaultTemplate()).setTemplate("modeller/configurators/rfr");
	}

	public void rfrSubmit(HttpServletRequest request)
	{
		RFRConfiguration conf = (RFRConfiguration) 
