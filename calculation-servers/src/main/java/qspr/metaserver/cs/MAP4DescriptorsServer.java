...
public class MAP4DescriptorsServer extends DescriptorsAbstractExecutableServer{
	...
	DataTable calculateDescriptors(DataTable dtMolecules,
		...
		String[] commands = new String[] { "export RDBASE=/opt/conda/envs/rxnfp/lib/python3.6/site-packages/rdkit; export PYTHONPATH=/opt/conda/envs/rxnfp/lib/python3.6/site-packages/rdkit; /opt/conda/envs/rxnfp/bin/python", getExeFile(), "-i", datain, "-o", dataout ,  "--dimensions", ""+ conf.dimensions,"--radius",  ""+conf.radius};
