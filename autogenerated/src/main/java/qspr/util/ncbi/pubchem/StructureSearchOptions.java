...
public class StructureSearchOptions  implements java.io.Serializable {
    ...
    private qspr.util.ncbi.pubchem.StereoType eStereo;
    ...
    public StructureSearchOptions(
           ...
           qspr.util.ncbi.pubchem.StereoType eStereo,
     ...
     * @return eStereo
     */
    public qspr.util.ncbi.pubchem.StereoType getEStereo() {
        return eStereo;
    }
     ...
     * @param eStereo
     */
    public void setEStereo(qspr.util.ncbi.pubchem.StereoType eStereo) {
        this.eStereo = eStereo;
    }
