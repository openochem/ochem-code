...
public class AssayDescriptionType  implements java.io.Serializable {
    ...
    private qspr.util.ncbi.pubchem.AssayTargetType[] targets;
    ...
    public AssayDescriptionType(
           ...
           qspr.util.ncbi.pubchem.AssayTargetType[] targets,
     ...
     * @return targets
     */
    public qspr.util.ncbi.pubchem.AssayTargetType[] getTargets() {
        return targets;
    }
     ...
     * @param targets
     */
    public void setTargets(qspr.util.ncbi.pubchem.AssayTargetType[] targets) {
        this.targets = targets;
    }
